...
public class Zapping {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println("Dame el código del primer canal: ");
			c1 = sc.nextInt();
			System.out.println("Dame el código del segundo canal: ");
			c2=sc.nextInt();
			...
			System.out.println("Camino óptimo: " + Math.min(camino1, camino2));
		}while (c1!=0 && c2!=0);
	}
